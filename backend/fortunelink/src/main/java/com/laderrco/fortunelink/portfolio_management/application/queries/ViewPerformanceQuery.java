...
// account id optional
public record ViewPerformanceQuery(PortfolioId portfolioId, UserId userId, AccountId accountId, Instant startDate, Instant endDate) implements ClassValidation {
