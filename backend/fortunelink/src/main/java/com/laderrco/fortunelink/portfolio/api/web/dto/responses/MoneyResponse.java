 ...
 *
 * The domain Money type serializes as:
 * {"amount": {"amount": 100.00, "currency": {"currencyCode": "CAD", ...}}}
 *
 * which is deeply nested, exposes internal domain structure, and is fragile
 * to internal refactoring. This DTO flattens it to:
 * {"amount": 100.00, "currency": "CAD"}
 *
 * Use this in every response record that needs to express a monetary value.
 * Never return raw Money domain objects through the API boundary.
 */
