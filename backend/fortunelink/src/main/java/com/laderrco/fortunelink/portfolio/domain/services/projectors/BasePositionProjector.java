...
public abstract class BasePositionProjector<P extends Position> implements
    Projector<P, Transaction> {
  ...
  protected abstract P getEmptyPosition(AssetSymbol symbol, AssetType type,
