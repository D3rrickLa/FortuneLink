...
public class UserProfileController {
  ...
  public ResponseEntity<UserProfileResponse> getProfile(
    ...
    return ResponseEntity.ok(new UserProfileResponse(profileService.getProfile(userId)));
  }
  ...
  public record UserProfileResponse(
      @Schema(example = "Jane Doe", description = "User display name") String fullName
  ) {
  }
