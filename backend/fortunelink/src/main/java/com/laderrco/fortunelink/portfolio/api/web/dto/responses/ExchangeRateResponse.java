...
public record ExchangeRateResponse(
  ...
  public static ExchangeRateResponse fromDomain(ExchangeRate r) {
    return new ExchangeRateResponse(r.from().getCode(), r.to().getCode(), r.rate(),
        r.quotedAt(), false);
  }

  public static ExchangeRateResponse identity(String currencyCode) {
    return new ExchangeRateResponse(currencyCode, currencyCode, BigDecimal.ONE, Instant.now(), true);
  }
}