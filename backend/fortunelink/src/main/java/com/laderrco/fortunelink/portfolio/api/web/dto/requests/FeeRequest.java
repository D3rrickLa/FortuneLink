...
public record FeeRequest(
    @Schema(description = "Category of the fee") @NotNull FeeType feeType,

    @Schema(description = "Cost of the fee", example = "9.99") @NotNull BigDecimal amount,

    @Schema(description = "Currency the fee was charged in", example = "USD") @NotBlank String currency) {
}