 ...
 * Use this for: -
 * Annual account maintenance fees - Wire transfer fees - Margin interest
 * charges - Management fees
 * billed to the account
 * <p>
 * Do NOT use this for trading commissions on a BUY or SELL , those are attached
 * to the trade via
 * the fees[] array on /buy or /sell. Trading fees attached to trades affect the
 * cost basis (ACB).
 * Standalone fees do not.
 * <p>
 * IMPORTANT: This is intentionally named RecordStandaloneFeeRequest to
 * distinguish it from
 * FeeRequest, which is the embedded fee line item within a buy/sell transaction
 * body. They serve
 * very different purposes.
 */
@Schema(description = "Request to record a standalone fee (e.g. Account Maintenance)")
public record RecordStandaloneFeeRequest(
    @Schema(example = "50.00") @NotNull @DecimalMin("0.01") BigDecimal amount,
