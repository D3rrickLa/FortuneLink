 ...
 * </p>
 * <p>
 * Values are stored internally as a decimal rate (e.g., {@code 0.15} for +15%, {@code -0.25} for
 * -25%).
 * </p>
 *
...
public record PercentageChange(BigDecimal change) implements Comparable<PercentageChange> {
  public static final PercentageChange ZERO;
  private static final int SCALE;
  private static final RoundingMode MODE;

  static {
    SCALE = Precision.PERCENTAGE.getDecimalPlaces();
    MODE = Rounding.PERCENTAGE.getMode();
    ZERO = new PercentageChange(BigDecimal.ZERO);
  }
