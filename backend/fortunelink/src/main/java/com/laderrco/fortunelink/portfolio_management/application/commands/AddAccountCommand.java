...
public record AddAccountCommand(PortfolioId portfolioId, UserId userId, String accountName, AccountType accountType, PositionStrategy strategy, Currency baseCurrency) {
}