...
public interface JpaRealizedGainRepository extends JpaRepository<RealizedGainJpaEntity, UUID> {
  ...
  @Query("""
      ...
      ORDER BY r.occurredAt DESC
      """)
  List<RealizedGainJpaEntity> findByAccountIdAndYear(@Param("accountId") UUID accountId,
      @Param("year") int year);
  ...
  @Query("""
      ...
      ORDER BY r.occurredAt DESC
      """)
  List<RealizedGainJpaEntity> findByAccountIdAndSymbol(@Param("accountId") UUID accountId,
  ...
  @Query("""
      ...
      ORDER BY r.occurredAt DESC
      """)
  List<RealizedGainJpaEntity> findByAccountIdAndYearAndSymbol(@Param("accountId") UUID accountId,
      @Param("year") int year, @Param("symbol") String symbol);
