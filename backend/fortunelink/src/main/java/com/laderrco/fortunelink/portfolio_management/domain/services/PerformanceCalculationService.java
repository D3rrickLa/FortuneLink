...
public class PerformanceCalculationService {
     ...
     * 
     * @return Percentage representing total portfolio return (e.g., 20% gain or -5% loss)
     */
     ...
     * Unrealized gains = paper gains you haven't locked in yet (still holding the asset).
     * 
     * Formula: (Current Market Value - Cost Basis) for each asset
     * 
     * Example: Own 100 shares, paid $1,000 total, now worth $1,200 = $200 unrealized gain
     * 
     ...
     * 
     * TWR is useful for comparing portfolio performance to benchmarks because it shows
     * how well your investments performed, independent of when you added/removed money.
     * 
     ...
     * 
     * This represents your "out of pocket" cost - how much actual cash you've put in
     * (minus any cash you've taken out).
     * 
     * Example: Bought $5,000 stocks + deposited $3,000 cash - withdrew $1,000 = $7,000 invested
     * 
