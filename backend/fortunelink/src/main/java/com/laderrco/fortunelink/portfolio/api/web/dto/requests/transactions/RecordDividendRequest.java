...
public record RecordDividendRequest(
    @Schema(example = "AAPL") @NotBlank @Pattern(regexp = "^[A-Z0-9.\\-]{1,20}$") String assetSymbol,
    @Schema(description = "Total dividend amount received", example = "25.50") @NotNull @DecimalMin("0.000001") BigDecimal amount,
