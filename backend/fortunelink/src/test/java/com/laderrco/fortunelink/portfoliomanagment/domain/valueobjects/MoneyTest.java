...
class MoneyTest {
    ...
    void divide_shouldReturnAmount() {
        ...
        assertEquals(Money.of(BigDecimal.valueOf(50).setScale(DecimalPrecision.MONEY.getDecimalPlaces()), USD), dividedMoney);
    }
    ...
    void negate_shouldReturnNegativeAmount() {
        ...
        assertEquals(BigDecimal.valueOf(-100), result.amount());
    }
    ...
    void ofFactory_shouldCreateMoneyWithCorrectAmount() {
        ...
        assertEquals(BigDecimal.valueOf(123.45), money.amount());
    }
}