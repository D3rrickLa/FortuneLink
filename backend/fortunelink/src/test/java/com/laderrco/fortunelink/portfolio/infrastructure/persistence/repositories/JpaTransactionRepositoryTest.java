...
@DataJpaTest(includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = {
    JpaTransactionRepository.class, JpaPortfolioRepository.class}))
@Testcontainers
@ActiveProfiles("test")
@EntityScan(basePackages = "com.laderrco.fortunelink.portfolio.infrastructure.persistence.entities")
...
class JpaTransactionRepositoryTest {
  ...
  void shouldProperlyProjectAggregatedFees() {
    ...
    PortfolioJpaEntity portfolio = PortfolioJpaEntity.create(portfolioId,
    ...
    FeeJpaEntity fee = FeeJpaEntity.create(tx, "BROKERAGE", null, "CAD", null, null, null, null,
    ...
    FeeAggregationResult result = results.getFirst();
