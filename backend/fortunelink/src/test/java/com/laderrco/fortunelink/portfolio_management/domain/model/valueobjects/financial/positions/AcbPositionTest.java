...
class AcbPositionTest {
    ...
    class SellTests {
        ...
        void sell_success_calculatesRealizedGain() {
            ...
            assertEquals(new BigDecimal("50.0000000000000000000000000000000000"), updated.totalCostBasis().amount(), "Cost basis should be halved");

            // Assert Gains
            assertEquals(new BigDecimal("50.0000000000000000000000000000000000"), result.costBasisSold().amount());
            assertEquals(new BigDecimal("30.0000000000000000000000000000000000"), result.realizedGainLoss().amount(), "80 proceeds - 50 cost = 30 gain");
        }
    ...
    class SplitTests {
        ...
        void split_success_2For1Split() {
            ...
            assertEquals(new BigDecimal("5.0000000000000000000000000000000000"), updated.costPerUnit().amount(), "New cost per unit should be $5");
        }
