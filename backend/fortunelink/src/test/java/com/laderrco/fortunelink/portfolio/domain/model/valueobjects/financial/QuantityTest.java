...
class QuantityTest {
    ...
    class PredicateTests {
        ...
        void isPositive_isZero_isNonZero_success() {
            ...
            assertThat(new Quantity(new BigDecimal(-1)).isNegative()).isTrue();
        }
        ...
        @Test
        @DisplayName("abs_success_ReturnsPositive")
        void abs_success_ReturnsPositive() {
            // While the constructor doesn't block negative,
            // some methods do. Testing abs for completeness.
            Quantity q = new Quantity(new BigDecimal("-10.00"));
            assertThat(q.abs().amount()).isEqualByComparingTo("10.00");
        }
    }
}