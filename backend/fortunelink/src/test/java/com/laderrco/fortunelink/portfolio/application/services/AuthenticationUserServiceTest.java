...
class AuthenticationUserServiceTest {
  ...
  class GetCurrentUserTests {
    ...
    void getCurrentUser_Failure_WhenSubIsNotUUID() {
      ...
      assertThatThrownBy(() -> authService.getCurrentUser()).isInstanceOf(
    ...
    void getCurrentUser_Failure_WhenAuthenticationIsNull() {
      ...
      assertThatThrownBy(() -> authService.getCurrentUser()).isInstanceOf(
          AuthenticationException.class).hasMessage("No authenticated user");
    }
  ...
  class GetCurrentUserEmailTests {
    ...
    void getCurrentUserEmail_Failure_WhenNotAuthenticated() {
      ...
      assertThatThrownBy(() -> authService.getCurrentUserEmail()).isInstanceOf(
  ...
  class VerifyOwnershipTests {
    ...
    void verifyUserOwnsPortfolio_Success_WhenUserIsOwner() {
      ...
      assertThatCode(
          () -> authService.verifyUserOwnsPortfolio(userId, portfolio)).doesNotThrowAnyException();
    }
    ...
    void verifyUserOwnsPortfolio_Failure_WhenUserIsNotOwner() {
      ...
      assertThatThrownBy(
          () -> authService.verifyUserOwnsPortfolio(strangerId, portfolio)).isInstanceOf(
          RuntimeException.class).hasMessage("Access denied: user does not own this portfolio");
    }
  }
