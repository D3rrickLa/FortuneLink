...
public class GetTransactionHistoryQueryTest {
    ...
    void shouldCreateValidQuery() {
        GetTransactionHistoryQuery query = new GetTransactionHistoryQuery(
            validPortfolioId, validUserId, null, null, null, null, 0, 50
        );
    ...
    void shouldHandleDefaultConstructor() {
        GetTransactionHistoryQuery query = new GetTransactionHistoryQuery(validPortfolioId, validUserId);
    ...
    void shouldThrowForNegativePage(int invalidPage) {
        assertThatThrownBy(() -> 
            new GetTransactionHistoryQuery(validPortfolioId, validUserId, null, null, null, null, invalidPage, 20)
    ...
    void shouldThrowForNonPositivePageSize(int invalidSize) {
        assertThatThrownBy(() -> 
            new GetTransactionHistoryQuery(validPortfolioId, validUserId, null, null, null, null, 0, invalidSize)
        ).isInstanceOf(IllegalArgumentException.class)
    ...
    void shouldThrowForTooLargePageSize() {
        assertThatThrownBy(() -> 
            new GetTransactionHistoryQuery(validPortfolioId, validUserId, null, null, null, null, 0, 101)
        ).isInstanceOf(IllegalArgumentException.class)
