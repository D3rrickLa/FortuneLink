...
public abstract class BaseControllerTest {
  ...
  /**
   * Returns a RequestPostProcessor that injects a valid JWT principal. Use this for standard
   * authenticated requests.
   * <p>
   * userId must be a valid UUID , it maps to the 'sub' claim your AuthenticationUserService reads.
   */
  protected RequestPostProcessor authenticatedUser(UUID userId) {
    return jwt().jwt(jwt -> jwt.subject(userId.toString()).claim("email", "test@fortunelink.com")
