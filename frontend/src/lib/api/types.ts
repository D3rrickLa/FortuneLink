...
export type PercentageChange =
  components["schemas"]["PercentageChange"];
...
export type AccountType =
  NonNullable<CreateAccountRequest["accountType"]>;

export type AccountStatus =
  NonNullable<AccountView["status"]>;

export type CostBasisStrategy =
  NonNullable<CreateAccountRequest["strategy"]>;
...
export type TransactionType =
  NonNullable<TransactionView["type"]>;

export type PageTransactionView =
...
export type CsvRowError =
  components["schemas"]["CsvRowError"];

export type ExcludeTransactionRequest =
  components["schemas"]["ExcludeTransactionRequest"];

// Transaction request bodies
export type RecordPurchaseRequest =
  components["schemas"]["RecordPurchaseRequest"];

export type RecordSaleRequest =
  components["schemas"]["RecordSaleRequest"];

export type RecordDepositRequest =
  components["schemas"]["RecordDepositRequest"];

export type RecordWithdrawalRequest =
  components["schemas"]["RecordWithdrawalRequest"];

export type RecordDividendRequest =
  components["schemas"]["RecordDividendRequest"];

export type RecordDRIPRequest =
  components["schemas"]["RecordDRIPRequest"];

export type RecordInterestRequest =
  components["schemas"]["RecordInterestRequest"];

export type RecordStandaloneFeeRequest =
  components["schemas"]["RecordStandaloneFeeRequest"];

export type RecordTransferInRequest =
  components["schemas"]["RecordTransferInRequest"];

export type RecordTransferOutRequest =
  components["schemas"]["RecordTransferOutRequest"];

export type RecordSplitRequest =
  components["schemas"]["RecordSplitRequest"];

export type RecordReturnOfCapitalRequest =
  components["schemas"]["RecordReturnOfCapitalRequest"];

// Asset type enum
export type AssetType =
  NonNullable<PositionView["assetType"]>;

// ─── Realized Gains ───────────────────────────────────────────────────────────
export type RealizedGainsSummaryResponse =
  components["schemas"]["RealizedGainsSummaryResponse"];

export type RealizedGainItemResponse =
  components["schemas"]["RealizedGainItemResponse"];
...
export type BatchQuoteRequest =
  components["schemas"]["BatchQuoteRequest"];

export type BatchQuoteResponse =
  Record<string, MarketQuoteResponse>;
...
export type UpdateUserPreferencesRequest =
  components["schemas"]["UpdateUserPreferencesRequest"];
